...
$sql="  INSERT INTO `vms`.`vendor details` (`name`, `ven_shop_name`, `ven_phone`, `ven_alt_phone`, `ven_email`, `ven_type`, `ven_rep_name`, `ven_rep_phone`, `ven_rep_email`, `ven_add`, `branch-loc`, `acc-num`, 
`bank_name`, `acc_holder_name`, `pan_num`, `upi_type`, `gst`, `ifsc`, `doi`, `doe`, `rea_exit`, `vendor_ref`, `remark`) VALUES ('$name', '$shopName', '$phone', '$altphone', '$email', '$type',
 '$repName', '$repPhone', '$repEmail', '$address', '$branchLocation', '$Account', '$bankname', '$Accountname', '$pannum', '$upiInput', '$GST', '$IFSC', '$joindate', current_timestamp(), 
 '$roe', '$ref', '$remark');
";
